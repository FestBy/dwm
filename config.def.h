/*
bread's dwm build and FestBy's fork
...
Also added function named centerfixed which on MODKEY + Button2 make window tiled and center, if it was floating 
*/
...
static const char *fonts[]          = { "monospace:size=10", "Hack Nerd Font Mono:size=16", "NotoColorEmoji:pixelsize=14:antialias=false:autohint=true"  };
...
/* script launch bindings */
	{ MODKEY|ShiftMask,		XK_n,      spawn,       {.v = (const char*[]){ "dmenu_notes", NULL } } },
	{ MODKEY,				XK_v,      spawn,       {.v = (const char*[]){ "dmenu_cliphist", "sel", NULL } } },
	{ MODKEY,				XK_c,      spawn,       {.v = (const char*[]){ "dmenu_cliphist", "add", NULL } } },
    { MODKEY|ControlMask,   XK_m,      spawn,       {.v = (const char*[]){ "dmenu_mount", NULL } } },
//    { MODKEY|ShiftMask,		XK_a,      spawn,       {.v = (const char*[]){ "dmenuvids", NULL } } },
    { MODKEY|ControlMask,   XK_a,      spawn,       {.v = (const char*[]){ "dmenu_audioswitch", NULL } } },
//	{ MODKEY|ShiftMask,		XK_d,      spawn,       {.v = (const char*[]){ "rip", NULL } } },
//	{ MODKEY,				XK_r,      spawn,       {.v = (const char*[]){ "rec", NULL } } },
	{ MODKEY|ShiftMask,     XK_grave,  spawn,       {.v = (const char*[]){ "define_word", NULL } } },
    { MODKEY,               XK_grave,  spawn,       {.v = (const char*[]){ "translate_word", NULL } } },
...
//	{ MODKEY,				XK_F10,    spawn,       SHCMD("playerctl -p termusic previous") },
	{ MODKEY|ShiftMask,		XK_F8,     spawn,       SHCMD("slock systemctl suspend -i") }, // pc sleep
	{ MODKEY,				XK_F8,     spawn,       SHCMD("slock") }, // pc block
...
//	{ MODKEY,				XK_F5,     spawn,       SHCMD("amixer -D pulse sset Master 5%-") },
    { Mod1Mask,             XK_Shift_L,spawn,       {.v = (const char*[]){ "toggle-kb.sh", NULL } } }, // change keyboard layout
    { Mod1Mask,             XK_Shift_R,spawn,       {.v = (const char*[]){ "toggle-kb.sh", NULL } } },
...
static const Button buttons[] = {
	...
	{ ClkStatusText,        ShiftMask,	Button3,	spawn,          SHCMD("st -e nvim ~/dwmblocks-async/config.h") },
    { ClkRootWin,           0,          Button2,    spawn,          SHCMD("st") },
...
//	{ ClkRootWin,			0,			Button2,	togglebar,      {0} }, /* hide bar */
    { ClkClientWin,         MODKEY,     Button2,    centerfixed, {0} }, // make window tiled and center, if it was floating 
};
